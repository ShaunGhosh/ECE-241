...
class OrderedDLList:
    ...
    def add(self, item):
        ...
        temp = Node(item)
        if current == None and previous == None:       # if there is nothing before or after
            temp.setNext(self.head)
            self.head = temp
            self.tail = temp 
        elif current == None:                # if there is nothing after 
            temp.setNext(current)
            self.tail = temp
            previous.setNext(temp)
            temp.setPrev(previous)
        elif previous == None:                 # if there is nothing before
            temp.setNext(self.head)
            self.head = temp
            self.head.getNext().setPrev(temp)
        else:                                      # if there is something before or after
            temp.setNext(current)
            previous.setNext(temp)
    ...
    def remove(self, item):
        ...
        if previous == None and current.getNext() == None: # if there is nothing before or after
            self.head = None
            self.tail = None
        elif previous == None:               # if there is nothing before
            self.head = current.getNext()
            current.setPrev(None)
        elif current.getNext() == None:    # if there is nothing after
            previous.setNext(None)
            self.tail = previous
        else:                           # if there something before and after
